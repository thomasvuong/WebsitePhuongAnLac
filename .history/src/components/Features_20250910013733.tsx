...
export default function Features() {
  ...
  const alternatingTexts = [
    ...
    {
      title: "Hoạt động Đảng bộ", 
      subtitle: "Đảng bộ phường An Lạc định hướng phát triển khu Tây TP.HCM",
      content: "Tập trung hoàn thiện hạ tầng và hình thành \"phố thương mại – logistics\" tại cửa ngõ miền Tây."
    }
  ]
