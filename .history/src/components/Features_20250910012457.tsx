      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow p-6">
            <div className="h-48 rounded-lg mb-4 overflow-hidden bg-gray-200 flex items-center justify-center">
              <span className="text-gray-500">card1.png</span>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow p-6">
            <div className="h-48 rounded-lg mb-4 overflow-hidden bg-gray-200 flex items-center justify-center">
              <span className="text-gray-500">card2.png</span>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow p-6">
            <div className="h-48 rounded-lg mb-4 overflow-hidden bg-gray-200 flex items-center justify-center">
              <span className="text-gray-500">card3.png</span>
            </div>
