        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 leading-tight">
              Đại hội Đảng bộ Thành phố Hồ Chí Minh lần thứ XI
            </h2>

            <p className="text-lg text-gray-600 leading-relaxed">
              Đảng ủy phường tổ chức hội nghị thông tin kết quả Đại hội Đảng bộ Thành phố
              lần thứ XI và học tập, quán triệt, triển khai thực hiện Nghị quyết Đại hội
              Đảng bộ Quận lần thứ XII, nhiệm kỳ 2020 - 2021.
            </p>
          ...
          <div className="relative">
            <div className="relative overflow-hidden rounded-2xl shadow-2xl">
              <img
                src="https://ext.same-assets.com/4131792006/1511803379.jpeg"
                alt="Đại hội Đảng bộ"
