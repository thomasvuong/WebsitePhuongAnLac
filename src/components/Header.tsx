          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-600 text-sm">
                Gọi đường dây nóng 24/7 tại 113 nếu bạn không chắc chắn về điều gì đó có phải là lừa đảo.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="flex items-center gap-4 -ml-6 sm:-ml-8">
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  <div className="text-sm font-bold text-red-600">UBND</div>
                  <div className="text-sm font-bold text-red-600">Phường An Lạc</div>
                </div>
              </div>
            </div>
